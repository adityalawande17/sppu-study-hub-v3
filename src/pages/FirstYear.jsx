...
export default function FirstYear() {
  ...
  useSEO({
    title:
      "First Year FE Notes and Solved Question Papers — SPPU | SPPUStudyHUB",
    description:
      "First Year FE SPPU engineering notes, question papers and practicals. Semester 1 and 2 for all branches. 2019 and 2024 pattern.",
  });

  const subjects =
    feSubjects[pattern]?.[activeSem] || feSubjects["2019"][activeSem];
    ...
    <div className="page-wrap">
      ...
      >
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            Common syllabus for all branches — FE. Updated as per the SPPU{" "}
            {pattern} pattern syllabus.
          </p>
        </div>
        <span
          style={{
      ...
      <div className="syllabus-strip">
        <div>
          ...
          >
            SPPU First Year Complete Syllabus — {pattern} Pattern
          </div>
      ...
      <div className="info-strip">
        First Year at SPPU has a common syllabus across all engineering
        branches. Select a semester to access notes, question papers, and
        practicals.
      </div>

      <div className="sem-tabs">
        <button
          className={`sem-tab ${activeSem === "sem1" ? "active" : ""}`}
          onClick={() => setActiveSem("sem1")}
        >
          Semester 1
        </button>
        <button
          className={`sem-tab ${activeSem === "sem2" ? "active" : ""}`}
      ...
      <div style={{ display: "grid", gap: 8, marginBottom: 8 }}>
        {subjects.map((s) => (
          <SubjectItem
            ...
            branchKey="fe"
            yearKey="FE"
            sem={activeSem === "sem1" ? "Semester 1" : "Semester 2"}
          />
        ))}
      </div>
