    ...
    <div className="container" style={{ padding: "40px 24px 80px" }}>
      ...
      >
        <div>
          ...
          <p
            style={{ color: "var(--text-3)", fontSize: 13, margin: "6px 0 0" }}
          >
          ...
          >
            This feature is still in testing phase. We apologise if you faced
            any issues — mail us at{" "}
            <a
              href="mailto:contact.sppustudyhub@gmail.com"
      ...
      {loading ? (
        ...
        >
          <p style={{ color: "var(--text-3)", fontSize: 14, marginBottom: 20 }}>
            No history yet. Open any subject page and ask AI to explain a
            question.
          </p>
        ...
        <div style={{ display: "grid", gap: 12 }}>
          ...
          >
            Only the last {MAX} answers are kept. Older ones are removed
            automatically.
          </p>
        </div>
      )}
